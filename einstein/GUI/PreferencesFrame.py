...
class PreferencesFrame(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.boxHR = wx.StaticBox(self.page3, -1, _("Heat recovery calculation"))
        ...
        self.par2_1 = ChoiceEntry(self.page3,
                               values=["estimate","PE2"],
    ...
    def __do_layout(self):
        ...
        self.page3.SetSizer(sizer_2)
                
        self.notebook.AddPage(self.page1, _('debug options'))
        self.notebook.AddPage(self.page3, _('calculation tools'))
