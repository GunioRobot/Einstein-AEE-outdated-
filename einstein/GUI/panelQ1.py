...
#------------------------------------------------------------------------------
        ...
        self.page3 = wx.Panel(self.notebook) # middle right panel
        self.notebook.AddPage(self.page3, _U('Period of operation'))
        self.page3.SetForegroundColour(TITLE_COLOR)
        self.page3.SetFont(wx.Font(8, wx.SWISS, wx.NORMAL, wx.BOLD))

        self.page4 = wx.Panel(self.notebook) # right panel
        self.notebook.AddPage(self.page4, _U('Information on products'))
        self.page4.SetForegroundColour(TITLE_COLOR)
        self.page4.SetFont(wx.Font(8, wx.SWISS, wx.NORMAL, wx.BOLD))
        ...
        self.frame_period_operation = wx.StaticBox(self.page3, -1, _U("Period of operation"))
        ...
        self.frame_information_products = wx.StaticBox(self.page4, -1, _U("Information on products"))
        ...
        self.frame_energy_consumption = wx.StaticBox(self.page4, -1, _U("Energy consumption by product"))
        ...
        self.frame_product_list = wx.StaticBox(self.page4, -1, _U("Product list"))
        ...
        self.st27 = wx.StaticText(self.page3,-1,
...
#HS2008-07-02 shifted down, so that field size for choice entry remains large
        ...
        self.listBoxProducts = wx.ListBox(self.page4,-1, choices=[])
        ...
        self.tc30 = TextEntry(self.page4,maxchars=255,value='',
                             label=_U("Type of product"),
                             tip=" ")

        self.tc31 = ChoiceEntry(self.page4, 
        ...
        self.tc33 = TextEntry(self.page4,maxchars=255,value='',
        ...
        # buttons
        #
        self.buttonAddProduct = wx.Button(self.page4,-1,label=_U('Add product'))
        ...
        self.buttonDeleteProduct = wx.Button(self.page4,-1,label=_U('Delete product'))
    ...
    def __do_layout(self):
        ...
        self.page3.SetSizer(sizerPage2)
        ...
        self.page4.SetSizer(sizerPage3)
...
#..............................................................................
# aqui parte que guarda la informaci�n del producto
