...
#------------------------------------------------------------------------------
        ...
        self.tc8_1 = FloatEntry(self.page0, decimals=1, minval=0., maxval=1.e+12, value=0.,
                              unitdict='TEMPERATURE',
                              label=_U("Required temperature for heating system"),
                              tip=_U("Specify the required forward temperature of the heating medium (hot water, air) to the heating system (radiators, radiant floor, fan coils, etc.)"))
        
        self.tc8_2 = FloatEntry(self.page0, decimals=1, minval=0., maxval=1.e+12, value=0.,
                              unitdict='TEMPERATURE',
                              label=_U("Required temperature for air conditioning system"),
                              tip=_U("Specify the required forward temperature of the cooling medium (cold water, air) to the air conditioning system (fan coils, radiant ceiling, etc.)"))
    ...
    def __do_layout(self):
        ...
        sizerP0RightBottom.Add(self.tc8_1, 0, flagText, VSEP_LEFT)
        sizerP0RightBottom.Add(self.tc8_2, 0, flagText, VSEP_LEFT)
...
#------------------------------------------------------------------------------
    ...
    def OnListBoxBuildingListClick(self, event):
        ...
        self.tc8_1.SetValue(str(q.BuildTHeating))
        self.tc8_2.SetValue(str(q.BuildTAirCond))
...
# assure that a name has been entered before continuing
            ...
            if len(buildings) == 0:
                ...
                tmp = {
                    ...
                    "BuildTHeating":check(self.tc8_1.GetValue()),
                    "BuildTAirCond":check(self.tc8_2.GetValue()),
