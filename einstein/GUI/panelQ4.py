...
#------------------------------------------------------------------------------
        ...
        self.notebook.AddPage(self.page4, _U('Schedule'))
        ...
        self.frame_schedule = wx.StaticBox(self.page4, -1, _U("Schedule"))
...
#next from Q4C
        ...
        self.tc20 = MultipleChoiceEntry(self.page3,
        ...
        self.tc32 = ChoiceEntry(self.page3,
                               values=[],
...
#next 2 from Q4C
        self.tc35 = ChoiceEntry(self.page3,
                               values=[],
