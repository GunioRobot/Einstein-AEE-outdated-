...
#------------------------------------------------------------------------------
        ...
        self.page3 = wx.Panel(self.notebook, -1)
        ...
        self.frame_biomass_processes = wx.StaticBox(self.page3, -1, "Availability of biomass from the processes")
        ...
        self.frame_biomass_region = wx.StaticBox(self.page3, -1, "Availability of biomass from the region")
        ...
        self.tc14 = TextEntry(self.page3,maxchars=255,value='',
        ...
        self.tc15_1 = DateEntry(self.page3,
                              value='',
                              label=_U("Start of period of year the biomass is available"),
                              tip=_U("Specify if the availability is continuous or during some specific season of the year"))

        self.tc15_2 = DateEntry(self.page3,
                              value='',
        ...
        self.tc21 = TextEntry(self.page3,maxchars=255,value='',
        ...
        self.tc23_1 = DateEntry(self.page3,
                              value='',
                              label=_U("Start of period of year the biomass is available"),
                              tip=_U("Specify if the availability is continuous or during some specific season of the year"))

        self.tc23_2 = DateEntry(self.page3,
                              value='',
                              label=_U("Stop of period of year the biomass is available"),
                              tip=_U("Specify if the availability is continuous or during some specific season of the year"))
    ...
    def __do_layout(self):
        ...
        self.notebook.AddPage(self.page3, "Biomass")
