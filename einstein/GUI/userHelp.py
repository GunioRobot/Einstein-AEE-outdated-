...
from einstein.modules.constants import RELEASE_VERSION, RELEASE_DATE
...
class FrameHelpAbout(wx.Dialog):
	...
	self.html.SetPage("<html><head><title>Einstein</title></head>"
		     ...
		     "<br><br>Version %s (%s)" % (RELEASE_VERSION, RELEASE_DATE) +
		     "<p>(C) copyleft energyXperts.NET (E4-Experts SL), Barcelona, Spain&nbsp;2008-2010</p>"
