...
#                print "CheckEq (calcs): fuel as main source"
            ...
            if self.EquipeClass in ["CH"]:  #temporary solution for chillers - equivalent heat model
                self.QWHEqTot1 = calcSum("QWHEqTot1",self.FETj,self.USHj)
            else:
...
#                print "adjust in mode BB"
            ...
            elif self.EquipeClass in ["CH"]:  #temporary solution for chillers - equivalent heat model
                adjustSum(self.QWHEqTot1,self.FETj3,self.USHj)
            else:
...
#------------------------------------------------------------------------------
            ...
            if self.EquipeClass == "CH":
                ccheck2(self.QWHEqTot,self.QWHEqTot1,self.QWHEqTot2)
